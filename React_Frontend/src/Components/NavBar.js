            ...
            <Navbar bg="dark" variant="dark">
                <Container style={{maxWidth:'90%'}}>
                    ...
                    <Nav className="ms-auto">
                        <NavDropdown title="Plan" id="plan-dropdown" renderMenuOnMount={true}>
                        ...
                        :<NavDropdown title={<span><i class="fas fa-user"></i>  Hello {currentUser.username}</span>} id="acc-dropdown" show={showAcc} onMouseEnter={showDropdown} onMouseLeave={hideDropdown}>
